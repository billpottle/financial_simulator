...
pdf_pages = PdfPages("/mnt/data/simulation_plots.pdf")
...
try:
    ...
    plt.text(0.5, 0.5, Optional file: lump_sums.csv not found, proceeding without it, ha='center', va='center', wrap=True)
    plt.axis('off')
...
def calculate_end_stats(): 
    ...
    # Print the insights
    plt.figure(figsize=(10, 5))
    plt.text(0.5, 0.5, \nKey Insights, ha='center', va='center', wrap=True)
    plt.axis('off')
    pdf_pages.savefig(plt.gcf())
    plt.close()
...
# Displaying the results table
    plt.figure(figsize=(10, 5))
    plt.text(0.5, 0.5, generate_results_table(, ha='center', va='center', wrap=True)
    plt.axis('off')
    pdf_pages.savefig(plt.gcf())
    plt.close()

    plt.figure(figsize=(10, 7))
    plt.text(0.5, 0.5, '''Optional file: lump_sums.csv not found, proceeding without it
    plt.axis('off')
    pdf_pages.savefig(plt.gcf())
    plt.close()
\nKey Insights
generate_results_table(''', ha='center', va='center', wrap=True)
plot_one()
plot_two()
plot_three()
plot_four()
